    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
           ...
           * `min-width:auto`, so a single unwrappable child — a select whose
           * value carries a long line, a URL, a wide table — widens the track
           * past the panel and everything anchored to it, footer included,
           * spills out of the rounded edge. */
